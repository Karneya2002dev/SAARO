...
export async function ContactHero() {
  ...
  return (
    <section className="overflow-hidden bg-white pt-10 pb-12 sm:pt-12 sm:pb-16 lg:pb-20">
      <div className="mx-auto w-full max-w-[1200px] px-4 sm:px-5 lg:px-6">
        <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.15fr)] lg:gap-14">
          <Reveal stagger={0.12}>
            <h1 className="text-[32px] font-bold leading-[1.15] tracking-[-0.025em] sm:text-[38px] lg:text-[44px]">
            ...
            <div className="mt-9 flex flex-wrap gap-4">
              ...
              <Link
                ...
                className="inline-flex min-h-12 items-center justify-center gap-2.5 rounded-full border-[1.5px] border-line bg-white px-7 py-2.5 text-center text-[14px] font-medium text-heading transition-colors hover:bg-surface sm:text-[15px]"
              >
                <WhatsApp className="size-4 shrink-0 text-brand" />
