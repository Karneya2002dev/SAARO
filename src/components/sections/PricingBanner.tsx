...
export async function PricingBanner() {
  ...
  return (
    <section className="bg-cream pt-10 sm:pt-12 lg:pt-16">
      <div className="mx-auto w-full max-w-[1200px] px-4 sm:px-5 lg:px-6">
        <Reveal className="mx-auto flex max-w-[1110px] flex-col gap-7 rounded-2xl bg-accent/12 px-6 py-7 sm:px-8 md:flex-row md:items-center md:justify-between md:gap-10">
          <div className="flex items-center gap-5 sm:gap-6">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[18px] font-semibold leading-[1.4] tracking-[-0.01em] text-heading sm:text-[20px]">
                {dict.pricingBanner.lineOne}
                <br />
                {dict.pricingBanner.lineTwo}
              </p>
          ...
          <Link
            href={`/${locale}/pricing`}
            className="inline-flex h-14 w-fit shrink-0 items-center gap-2.5 rounded-full border-2 border-heading bg-accent px-6 text-[14px] font-semibold text-heading shadow-[3px_4px_0_0_var(--color-heading)] transition-transform hover:-translate-y-0.5 sm:text-[15px]"
          >
